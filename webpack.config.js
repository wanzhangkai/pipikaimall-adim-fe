/*
* @Author: pipikai
* @Date:   2018-1-9 13:19:28
* @Last Modified by:   pipikai
* @Last Modified time: 2018-1-21 18:13:41
...
var config = {
    ...
    output: {
        path        : __dirname + '/dist/',
        publicPath  : WEBPACK_ENV === 'online' ? '//s.pipikai.xin/pipikaimall-admin-fe/dist/' : '/dist/',
        filename    : 'js/[name].js'
    },
    resolve: {
        alias: {
